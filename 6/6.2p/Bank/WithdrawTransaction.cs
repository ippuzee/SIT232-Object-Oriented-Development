...
namespace TASK_1
{
    internal class WithdrawTransaction 
    {
        ...
        // Method to execute the account operations
        public void Execute()
        {
            if (_executed)
            {
        ...
        // Roll back method to reverse any changes to the account if anything goes wrong during any kind of operation
        ...
        // properties to make them accessible
